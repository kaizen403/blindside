...
const from = process.env.EMAIL_FROM || "Blind Side <onboarding@resend.dev>";
...
export function magicLinkEmail(url: string) {
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #09090b; color: #fafafa; border-radius: 16px;">
      <h1 style="font-family: Georgia, serif; font-size: 28px; margin: 0 0 8px;">Sign in to Blind Side</h1>
...
export function verifyEmail(url: string) {
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #09090b; color: #fafafa; border-radius: 16px;">
      ...
      <p style="color: #a1a1aa; font-size: 14px; margin: 0 0 24px;">Confirm your email to activate your Blind Side account.</p>
...
export function inviteEmail(orgName: string, url: string) {
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #09090b; color: #fafafa; border-radius: 16px;">
      ...
      <p style="color: #a1a1aa; font-size: 14px; margin: 0 0 24px;">Access pentest reports, timelines and findings for ${orgName} on Blind Side.</p>
